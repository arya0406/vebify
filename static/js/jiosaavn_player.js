/**
 * JioSaavn Music Player
 * This script handles the JioSaavn music player functionality.
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadTrack(index) {
        ...
        currentTrackAlbum.textContent = track.album || '-';
    ...
    function toggleLike() {
        ...
        fetch(`/jiosaavn/api/tracks/${track.id}/like/`, {
            method: 'POST',
            headers: {
    ...
    function logPlayToServer(trackId) {
        fetch(`/jiosaavn/api/tracks/${trackId}/play/`, {
            method: 'POST',
            headers: {
    ...
    function loadTracksByMood(mood) {
        ...
        fetch(`/jiosaavn/api/tracks/mood/${mood}/`)
            .then(response => response.json())
            .then(data => {
